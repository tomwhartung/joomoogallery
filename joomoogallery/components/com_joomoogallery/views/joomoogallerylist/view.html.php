<?php
/**
 * @version     $Id: view.html.php,v 1.9 2008/10/31 06:37:08 tomh Exp tomh $
 ...
 */
class JoomoogalleryViewJoomoogalleryList extends JView
{
	function display($tpl = null)
	{
		$app = JFactory::getApplication();

		// print "view.html.php: top of JoomoogalleryViewJoomoogalleryList::display()<br />\n";
